...
"use strict";$(function(){$(window).scroll(function(){$(this).scrollTop()>$(this).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".top").click(function(){$("html,body").stop().animate({scrollTop:0},"slow","swing")}),$("#my-menu").mmenu({extensions:["effect-menu-slide","pagedim-black","theme-dark"],navbar:{title:'<img src="../dist/img/startup.png">'},offCanvas:{position:"right"}}),$("#my-menu").data("mmenu").bind("open:finish",function(){setTimeout(function(){$(".hamburger").addClass("is-active")},100)}).bind("close:finish",function(){$(".hamburger").removeClass("is-active")}),$(".owl-carousel").owlCarousel({loop:!0,nav:!1,smartSpeed:700,items:1})}),$(".loader").ready(function(){setTimeout(function(){$(".loader").fadeOut("slow",function(){$(document).ready()&&$(this).remove()})},2e3)});